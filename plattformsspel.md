...
3. Skapa en hitbox som rör sig likadant som karaktären, och en som rör sig likadant som figuren i deluppgiften ovan. Det går också att använda Sprite iställer för Hitbox, det funkar likadant men Sprite har lite fler saker och kan t.ex. visa en bild.  Såhär kan man skapa en hitbox:
```
